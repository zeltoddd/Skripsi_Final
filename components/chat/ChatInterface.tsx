...
export default function ChatInterface(props: ChatInterfaceProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-background overflow-hidden relative">
      ...
      {/* ─── Messages Area ─── */}
      <div ref={scrollContainerRef} className="flex-1 overflow-y-auto px-4 pt-6 scrollbar-hide">
        <div className="max-w-2xl mx-auto w-full space-y-6 pb-6">
          {props.messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center flex-1 gap-6 mt-10 md:mt-6">
              <div className="animate-in fade-in zoom-in-95 duration-700 flex justify-center">
                <img src="/vokara-stacked.svg" alt="VOKARA" className="h-24 dark:invert opacity-100" />
              </div>
              ...
              {props.suggestedPrompts && props.suggestedPrompts.length > 0 && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 w-full max-w-2xl mt-1 animate-in fade-in slide-in-from-bottom-6 delay-500 duration-700">
      ...
      {/* ─── Input Area ─── */}
      <div className="shrink-0 relative px-4 pb-6 pt-2 z-20 bg-background">
        ...
        <div className="max-w-2xl mx-auto w-full">
          ...
          {/* Input container */}
          <div className="bg-background border border-foreground/15 shadow-[0_2px_8px_-3px_rgba(0,0,0,0.05)] rounded-2xl p-2.5 px-3.5 transition-all relative z-10">
            {/* File Previews */}
            ...
            <Textarea
              ...
              className="min-h-[28px] max-h-32 py-0 px-0 border-none shadow-none focus-visible:ring-0 text-sm md:text-[15px] resize-none bg-transparent placeholder:text-muted-foreground/70 font-medium leading-relaxed"
              rows={1}
            />
            ...
            <div className="flex items-center justify-between mt-2 pt-1.5 border-t border-border/5">
              ...
              <div className="flex items-center gap-3">
                ...
                <Button
                  ...
                  size="icon"
                  className={cn(
                    "rounded-xl h-8 w-8 transition-all duration-200 shrink-0 shadow-sm",
